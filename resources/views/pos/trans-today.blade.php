<div class="row mx-1">
    @foreach ($items as $transToday)
        <div class="card mx-1 col-md-4" style="border-radius: 10px;">
            <a href="#" onclick="ChooseTrans({{ $transToday->id }})"
                class="d-flex align-items-center text-body lh-1 py-sm-2 p-2">
